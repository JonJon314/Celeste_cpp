...
#include <sys/stat.h> //timestamp of files
...
// Reads a file into a supplied buffer. I am managing my own memory and therefore want more control over where it is allocated
